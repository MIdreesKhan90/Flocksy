<?php
/*
 * Template Name: Unlimited Copywrite New Page
 */
get_header();
?>
                                    ...
                                    <div class="work-slide-body">
                                        ...
                                        <div id="popup-member-<?php echo $key; ?>" class="popup-content"
                                            ...
                                            <div class="preview-image">
                                                ...
                                                if ($popup_content) {
                                                    echo '<img src="' . $popup_content["url"] . '" alt="Web Development Design">';
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php get_template_part('template-parts/section', 'accordion-tabs') ?>
    ...
    <section class="py-70 bg-light-grey copywrite-content-section footer-top-content-section">
        <div class="container">
            <div class="content-block block-1">
                <div class="row">
                    <div class="col-md-7">
                        <h1><?php echo get_field("block_1_left_title"); ?></h1>
                        <?php echo get_field("block_1_left_content"); ?>
                    </div>
                    <div class="col-md-5">
                        <div class="white-box border-top-green">
                            <h2><?php echo get_field("block_1_white_box_title"); ?></h2>
                            <ul class="dots-ul green">
                                <?php
                                if (have_rows('copy_write_right_list')):
                                    while (have_rows('copy_write_right_list')) : the_row(); ?>
                                        <li><?php echo get_sub_field('right_list_item'); ?></li>
                                        <?php
                                    endwhile;
                                else :
                                endif;
            ...
            <div class="content-block block-2">
                <div class="row align-center">
                    ...
                    <div class="col-md-5">
                        <img src="<?php echo get_field("on_boarding_image"); ?>" alt="graphics">
                    </div>
                </div>
            </div>
    ...
    <section class="bg-green text-white green-section footer-top-content-section">
        <div class="container">
            <div class="row">
                <div class="col-md-4 left">
                    <?php echo get_field("green_section_left_text"); ?>
                </div>
                <div class="col-md-4 text-center">
                    <img src="<?php echo get_field("green_section_center_image"); ?>" alt="green-section-image">
                </div>
                <div class="col-md-4 right">
                    <?php echo get_field("green_section_right_text"); ?>
                </div>
            </div>
        </div>
    </section>
