...
/*
 * Template Name: Unlimited Graphic Design Page
 */
get_header(); 
?>
<div class="container">
                   ...
                   <div class="hero-banner-section custom-section custom-margin-bottom">
                        <div class="text-holder">
                            <h1 class="title-block"><?php echo get_field("ugd_hero_section_title"); ?></h1>
                            <div class="text-block">
                                <?php echo get_field("ugd_hero_section_textblock"); ?>
                            </div>
                            <a href="<?php echo get_field("ugd_hero_section_button_link"); ?>" class="btn"><?php echo get_field("ugd_hero_section_button_text"); ?></a>
                        </div>
                        <div class="image-holder">
                            <picture>
                                <source srcset="<?php echo get_field("ugd_hero_section_image"); ?>" media="(min-width: 768px)">
                                <source srcset="<?php echo get_field("ugd_hero_section_image_mobile"); ?>">
                                <img src="<?php echo get_field("ugd_hero_section_image"); ?>" alt="Graphic Design">
                            </picture>
                        </div>
                    </div>
                   ...
                   <div class="logo-banner-section custom-section">
                    ...
                    <div class="info-member-section">
                        <div class="text-holder pb-0">
                            <div class="text-holder-header">
                                <div class="title-global-section"><?php echo get_field("ugd_info_member_section_title"); ?></div>
                                <div class="text-block">
                                    <?php echo get_field("ugd_info_member_section_texblock"); ?>
                                </div>
                            </div>
                            <div class="image-block">
                                <img src="<?php echo get_field("ugd_info_member_section_image"); ?>"alt="Recent Work">
                            </div>
                        </div>
                        <div class="slider-holder">
                            <div class="member-work-slider js-info-slider">
                        		...
                        		$i=1;
										...
										if( have_rows('ugd_info_member_item') ) 	
                                        
                                        {
                                        	while( have_rows('ugd_info_member_item') ) 
                                        	{
                                        	    the_row();
                                        		?>
                    ...
                    <div class="banner-green-section">
                        <h2 class="title-global-section text-center"><?php echo get_field("ugd_banner_green_title"); ?></h2>
                        ...
                        <div class="column-list">
                            ...
                            <?php
                                        ...
                                        if( have_rows('ugd_banner_green_item') ) {
                                            while( have_rows('ugd_banner_green_item') ) {
                                                the_row();
                        ...
                        <div class="text-center">
                            <a href="<?php echo get_field("ugd_banner_green_button_link"); ?>" class="btn"><?php echo get_field("ugd_banner_green_button_text"); ?></a>
                        </div>
                    </div>
                                    ...
                                    $args = array(
                                        ...
                                        "tax_query" => array(
                                            ...
                                            array(
                                                ...
                                                'field' => 'slug',
                                                'terms' => "how-unlimited-graphic-design-works"
                                            )
                                                        ...
                                                        if(!empty($port_preview_video)){
                                                            ...
                                                            if(get_field("more_than_one_image")=='yes')
                                                            {
                                                                ...
                                                                foreach($rows as $row)
                                                                {
                                                                    if($f==0)
                                                                    {
                                                                        echo '<img src="'.$row['ppi_images'].'" alt="'.$port_title.'">';     
                                                                        $f=1;
                                                                    }
                                                                    else
                                                                    {
                                                                        echo '<img class="hide" src="'.$row['ppi_images'].'" alt="'.$port_title.'">';            
                                                                    }
                                                                }
                                                            ...
                                                            {
                                                                echo '<img src="'.get_field("preview_popup_image").'" alt="'.$port_title.'">';
                                                            }
                                                            ?>
                                                            <?php
                                                        }
                   ...
                   <div class="banner-free-section">
                        <div class="image-block image-left">
                            <img src="<?php echo get_field("ugd_banner_free_left_image"); ?>" alt="images">
                        </div>
                        <div class="image-block image-right">
                            <img src="<?php echo get_field("ugd_banner_free_right_image"); ?>" alt="images">
                        </div>
                        <div class="text-holder text-center">
                            <h2 class="title-global-section"><?php echo get_field("ugd_banner_free_title"); ?></h2>
                            <br>
                            <br>
                            <ul class="banner-free-list">
                                <?php
                                $bfl = explode("\n", str_replace("\r", "", get_field("ugd_banner_free_list")));
                                foreach($bfl as $b)
                                            {
                                                echo "<li>".$b."</li>";
                                            }
                            ...
                            <br>
                            <br>
                            <h2 class="title-global-section font-weight-bold"><?php echo get_field("ugd_banner_free_footer_title"); ?></h2>
                            <a href="<?php echo get_field("ugd_banner_free_button_link"); ?>" class="btn"><?php echo get_field("ugd_banner_free_button_text"); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="banner-statistic-section">
                        <div class="banner-statistic-header text-center">
                            <h2 class="title-global-section"><?php echo get_field("ugd_statistics_title"); ?></h2>
                        </div>
                        <div class="column-list">
                            <div class="column-item column-item-small">
                                ...
                                <?php
                                     ...
                                     //   $rows=get_field("ugd_statistics_item");
                                        
                                        if( have_rows('ugd_statistics_item') ) {
                                            while( have_rows('ugd_statistics_item') ) {
                                                the_row();
                                        		?>
                            ...
                            <div class="column-item column-item-big">
                                <div class="statistic-image-block">
                                    <picture>
                                        <source srcset="<?php echo get_field("ugd_statistics_image"); ?>" media="(min-width: 768px)">
                                        <source srcset="<?php echo get_field("ugd_statistics_mobile_image"); ?>">
                                        <img src="<?php echo get_field("ugd_statistics_image"); ?>" alt="Statistics">
                                    </picture>
                                </div>
                            </div>
                        </div>
            ...
            $args = array(  
                ...
                'tax_query' => array(             
                 array(
                    ...
                    'field' => 'slug',
                    'terms' => 'unlimited-graphic-design'
                )
                    ...
                    <div class="slider-image-section custom-section-2 reverse-section">
                        <div class="slider-image js-slider">
                            ...
                            <?php
                               ...
                               // $rows=get_field("ugd_slider_image_items");
                                
                               if( have_rows('ugd_slider_image_items') ) {
                                    while( have_rows('ugd_slider_image_items') ) {
                                        the_row();
                                		?>
                                		...
                                		<div class="slide">
                                            ...
                                            <div class="image-holder">
                                                ...
                                                <div id="popup-slider-01" class="popup-content" style="display: none;">
                                                    <div class="preview-image js-copywriting-images">
