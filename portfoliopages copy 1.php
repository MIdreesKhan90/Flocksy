              ...
              <div class="vertical-portfolio">
                  <ul id="accordion" class="portfolio-tabset accordion">
                    <li class="portfolio-tabset-item firstt">
                        <button data-tab="#tab-04">Favorites</button>
                    </li>
                    <li>
                   <div class="link">Design<i class="fa fa-chevron-down"></i></div>
                    ...
                    <!--<li class="portfolio-tabset-item">
                        <button data-tab="#tab-06">Marketing Material</button>
                    </li>-->
                    <li class="portfolio-tabset-item">
...
<li> <div class="link">Illustrations<i class="fa fa-chevron-down"></i></div>
     <ul class="submenu">
                    <li class="portfolio-tabset-item">
...
<li><div class="link">Voice Over<i class="fa fa-chevron-down"></i></div>
                    <ul class="submenu">
                    <li class="portfolio-tabset-item">
                        <button data-tab="#tab-31">All Voice Over</button>
                    </li>
                   </ul>
<li><div class="link">Motion Graphics<i class="fa fa-chevron-down"></i></div>
                    <ul class="submenu">
                    <li class="portfolio-tabset-item">
...
<li><div class="link">Web Development<i class="fa fa-chevron-down"></i></div>
                    <ul class="submenu">
                    <li class="portfolio-tabset-item">
            ...
            <div class="portfolio-tab-content">
              ...
              <div id="tab-02" class="portfolio-tab-content-item js-content-holder">
                 ...
                 <div id="tab-03" class="portfolio-tab-content-item js-content-holder">
                  ...
                  <div id="tab-04" class="portfolio-tab-content-item js-content-holder">
                    <div class="portfolio-scroll-content">
                        <div class="portfolio-list js-list">
                              <?php
                                $args = array(  
        ...
        <div class="testimonial-slider-section">
            ...
            <div class="testimonial-slider-nav">
        		...
        		<div class="testimonial-slide">
                    <div class="testimonial-slide-holder">
                        <div class="image-block">
                            <img src="<?php echo get_field("client_image"); ?>" alt="<?php echo get_field("client_name"); ?>">
                        </div>
                        <div class="text-block">
                            <span class="facebook-link">
                                <img src="https://flocksy.com/wp-content/themes/hello-theme-child-master/images/testimonial-slider-section/icon01.png" alt="icon">
                            </span>
                            <h4 class="name-block"><?php echo get_field("client_name"); ?></h4>
